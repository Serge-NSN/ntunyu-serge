...
export const videos = [
  ...
  },
  {
    ...
    catLabel: "Promo Video",
    catClass: "",
    title: "Product Launch — [ProVen]",
    desc: "Dynamic product launch video for Chinese audience with motion graphics and cinematic colour grading.",
    youtubeId: "XrmZjWHPi0c",
    aspect: "square",
  },
  {
    id: 3,
  ...
  },
  {
    ...
    catClass: "cat-recap",
    title: "Event Highlight Reel — [BCC 2026]",
    desc: "A vibrant recap capturing the best moments of the event with rhythmic cuts. All captured and edited by me.",
    youtubeId: "jASoe7Vdv2w",
    aspect: "portrait",
  },
  {
    id: 5,
    category: "promo",
    catLabel: "AI/Motion Graphics",
    catClass: "cat-recap",
    title: "Product Ad — [MALEGADO]",
    desc: "Fast-paced sports engaging AI Ad",
    youtubeId: "-NYepQDPBRg",
    aspect: "landscape",
  },
  {
    id: 6,
    ...
    catLabel: "Recap & Highlight",
    catClass: "cat-recap",
    title: "Year in Review — [BCC26 Masterclass]",
    desc: "Masterclass session highlight, Bamenda Community Challenge",
    youtubeId: "T29EVnlNv14",
    aspect: "portrait",
  },
  {
    id: 7,
 ...
 
  {
    ...
    title: "Faceless Content — [Wealth Niche]",
    desc: "Engaging faceless YouTube content with smooth voiceover and edits.",
    youtubeId: "KEa7p5XVM70",
    aspect: "landscape",
  },
  {
    id: 10,
  ...
  },
  {
    ...
    catLabel: "AI Video",
    catClass: "cat-ai",
    title: "AI-Generated Film — [MALEGADO Indonesia]",
    desc: "Cutting-edge AI video creation blending generative visuals with storytelling for an advert.",
    youtubeId: "vGGTMzjhojU",
    aspect: "landscape",
  },
  {
    id: 13,
  ...
  },
  {
    ...
    catLabel: "AI Video",
    catClass: "cat-ai",
    title: "AI Cinematic — [Faceless YT Bible Stories Channel]",
  ...
  // ---- VIDEOGRAPHY (Shot & Edited) ----
  {
    ...
    title: "Event Coverage — [Orfa AI]",
    desc: "Full event cover (Documentary style) — shot by me with my smartphone, edited my PC. Every precious moment captured with a cinematic eye.",
    youtubeId: "N9UciUL4mvM",
    aspect: "landscape",
  },
  {
    id: 18,
    ...
    catLabel: "Videography",
    catClass: "cat-videography",
    title: "Wedding Highlights — [Traditional Marriage]",
    desc: "A  wedding highlight reel — shot on a smartphone and edited to perfectly capture the emotion of the day.",
    youtubeId: "JM9sCobkpJg",
    aspect: "portrait",
  },
  {
    id: 19,
    ...
    catLabel: "Videography",
    catClass: "cat-videography",
    title: "Event Coverage — [Traditional Marriage]",
    desc: "Decor videography — capturing real moments, real emotions, and real stories as they unfold. All captured by myself, and with smartphone.",
