          ...
          >
            {contactLinks.map((link) => (
              <a
                ...
                className={`contact-link ${link.waStyle ? 'contact-link--wa' : ''}`}
              >
                <div
                ...
                <div>
                  ...
                  <div className="contact-link-val">{link.value}</div>
                </div>
              </a>
            ))}
          </motion.div>
